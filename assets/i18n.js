...
window.FD_I18N = (function () {
  const dict = {
    ru: {
      ...
      'err.server': 'Ошибка сервера. Откройте /api/health.php для диагностики.',
      'err.server_error': 'Ошибка сервера. Откройте /api/health.php для диагностики.',
      'err.storage_error': 'Не удалось записать в файл. Проверьте права на папку data/ (chmod 755).',
      'err.data_dir_not_writable': 'Папка data/ недоступна для записи. Поставьте права 755.',
      'err.php_too_old': 'Слишком старая версия PHP на хостинге. Нужна 7.4 или выше.',
    ...
    uk: {
      ...
      'err.server': 'Помилка сервера. Відкрийте /api/health.php для діагностики.',
      'err.server_error': 'Помилка сервера. Відкрийте /api/health.php для діагностики.',
      'err.storage_error': 'Не вдалося записати у файл. Перевірте права на теку data/ (chmod 755).',
      'err.data_dir_not_writable': 'Тека data/ недоступна для запису. Встановіть права 755.',
      'err.php_too_old': 'Застара версія PHP на хостингу. Потрібна 7.4 або новіша.',
    ...
    en: {
      ...
      'err.server': 'Server error. Open /api/health.php to diagnose.',
      'err.server_error': 'Server error. Open /api/health.php to diagnose.',
      'err.storage_error': 'Cannot write to disk. Check data/ permissions (chmod 755).',
      'err.data_dir_not_writable': 'data/ folder is not writable. Set permissions to 755.',
      'err.php_too_old': 'PHP on this host is too old. Need 7.4 or newer.',
