...
<main class="adm-shell">
  ...
  <section class="adm-main">
    ...
    <div class="quick-links">
      <a class="btn btn-primary" href="/admin/products.php?new=1" data-i18n="admin.quick.newProduct">Новый товар</a>
      <a class="btn btn-ghost" href="/admin/categories.php" data-i18n="admin.quick.manageCats">Категории</a>
      <a class="btn btn-ghost" href="/admin/users.php" data-i18n="admin.quick.users">Пользователи</a>
    </div>
  </section>
</main>
<?php layout_foot(); ?>
